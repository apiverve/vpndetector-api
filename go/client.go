// Package vpndetector provides a Go client for the VPN Proxy Detector API.
//
// For more information, visit: https://apiverve.com/marketplace/vpndetector?utm_source=go&utm_medium=readme
package vpndetector
...
const (
	baseURL        = "https://api.apiverve.com/v1/vpndetector"
	defaultTimeout = 30 * time.Second
)

// Client is the VPN Proxy Detector API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new VPN Proxy Detector API client.
...
// Execute makes a request to the VPN Proxy Detector API with typed parameters.
//
...
//   - ip (required): string - The IP address you want to check for VPN usage [format: ip]
