...
{
    class VPNProxyDetectorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/vpndetector";

        /// <summary>
        /// Make a GET request to the VPN Proxy Detector API
        /// </summary>
        static async Task<JsonDocument> CallVPNProxyDetectorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;ip&quot;] &#x3D; &quot;103.62.49.210&quot; };
        ...
        {
            Console.WriteLine("📤 Calling VPN Proxy Detector API...\n");

            var result = await CallVPNProxyDetectorAPI();
