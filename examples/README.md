# VPN Proxy Detector API - Examples

This folder contains example code for using the VPN Proxy Detector API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/vpndetector',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/vpndetector");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/vpndetector](https://docs.apiverve.com/ref/vpndetector)
