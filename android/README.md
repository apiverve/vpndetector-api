# VPN Proxy Detector Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:vpndetector-api:1.1.14'
}
```
...
```java
import com.apiverve.vpndetector.VPNProxyDetectorAPIClient;
import com.apiverve.vpndetector.APIResponse;
import com.apiverve.vpndetector.APIException;

// Initialize the client
VPNProxyDetectorAPIClient client = new VPNProxyDetectorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("ip", "103.62.49.210");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/vpndetector](https://docs.apiverve.com/ref/vpndetector)
...
- **Documentation:** [https://docs.apiverve.com/ref/vpndetector](https://docs.apiverve.com/ref/vpndetector)
- **Issues:** [GitHub Issues](https://github.com/apiverve/vpndetector-api/issues)
