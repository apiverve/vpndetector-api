...
class vpndetectorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/vpndetector');
        }
        ...
        this.validationRules = {"ip":{"type":"string","required":true,"format":"ip"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/vpndetector`);
        }
    }
...
module.exports = vpndetectorWrapper;
