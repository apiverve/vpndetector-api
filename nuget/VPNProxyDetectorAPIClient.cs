...
namespace APIVerve.API.VPNProxyDetector
{
    ...
    /// <summary>
    /// Client for the VPNProxyDetector API
    /// </summary>
    public class VPNProxyDetectorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/vpndetector";
        ...
        {
            { "ip", new ValidationRule { Type = "string", Required = true, Format = "ip" } }
        };
        ...
        public VPNProxyDetectorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public VPNProxyDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public VPNProxyDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, VPNProxyDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(VPNProxyDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(VPNProxyDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(VPNProxyDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(VPNProxyDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(VPNProxyDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(VPNProxyDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(VPNProxyDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(VPNProxyDetectorQueryOptions options)
        {
