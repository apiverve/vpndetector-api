...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/vpndetector',
        'Source': 'https://github.com/apiverve/vpndetector-api',
        'Bug Tracker': 'https://github.com/apiverve/vpndetector-api/issues'
    },
    classifiers=[
